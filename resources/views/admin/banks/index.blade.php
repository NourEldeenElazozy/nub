                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('banks.update', Crypt::encrypt($section->id)) }}"
                                    method="post">
                                    {{ method_field('put') }}
                                    @csrf
                ...
                <div class="modal fade" id="delete{{ $section->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('banks.destroy', Crypt::encrypt($section->id)) }}"
                                    method="post">
                                    {{ method_field('Delete') }}
                                    @csrf
                                    <h3 class="text-center">هل انت متأكد من عملية الحذف ؟</h3>
                                    <p class="text-center"> اذا تم الحذف سوف يتم حذف كل ماهو متعلق بهذا العمله</p>
                                    <div class="modal-footer">
