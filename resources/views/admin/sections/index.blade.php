                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('sections.update', Crypt::encrypt($section->id)) }}"
                                    method="post">
                                    {{ method_field('put') }}
                                    @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('sections.destroy', Crypt::encrypt($section->id)) }}"
                                    ...
                                    <p class="text-center"> اذا تم الحذف سوف يتم حذف كل ماهو متعلق بهذا المرسل</p>
                                    <div class="modal-footer">
